...
public class Func1 {
	...
	public static boolean pal2(int n ) {
		if(n == rev(n)) {
			System.out.println("Number" + n +" is Pallindrome." );
			return true;
	...
	public static void main(String[] args) {
		...
		System.out.println("Factorial is :"+ Facto(6));
		...
		System.out.println("Maximum among four is : "+Max(234,747,853,974));
		pal2(24542);
		pal2(45678);
		pal2(12321);
		pal2(131);
